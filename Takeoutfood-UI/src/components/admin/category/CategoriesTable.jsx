...
const CategoriesTable = () => {
  ...
  const DeleteCategory = async (id) => {
    try {
      await axios.delete(`http://takeoutfood.k8s.com/product-service/api/category/${id}`);
      fetchCategoryData();
  ...
  const addCategory = async () => {
    try {
      const response = await axios.post(
        "http://takeoutfood.k8s.com/product-service/api/category/add",
        {
          title: categoryName,
  ...
  const updateCategory = async () => {
    try {
      await axios.put(
        `http://takeoutfood.k8s.com/product-service/api/category/${selectedCategory.id}`,
        {
