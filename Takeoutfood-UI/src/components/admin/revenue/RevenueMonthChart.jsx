...
const RevenueMonthChart = () => {
  ...
  const fetchDefaultData = async () => {
    try {
      const response = await axios.get("http://takeoutfood.k8s.com/order-service/api/bill/revenue/month/latest");
  ...
  const fetchRevenueData = async () => {
    ...
    try {
      const response = await axios.get(
        "http://takeoutfood.k8s.com/order-service/api/bill/revenue/month",
        {
