...
const AccountsTable = () => {
  ...
  const blockAccount = async (id) => {
    try {
      const response = await axios.put(
        `http://takeoutfood.k8s.com/identity-service/api/account/block/${id}`
      );
  ...
  const openAccount = async (id) => {
    try {
      const response = await axios.put(
        `http://takeoutfood.k8s.com/identity-service/api/account/open/${id}`
      );
      fetchAccountData();
  ...
  const deleteAccount = async (id) => {
    try {
      await axios.delete(`http://takeoutfood.k8s.com/identity-service/api/account/${id}`);
      fetchAccountData();
  ...
  const fetchAccountData = async () => {
    try {
      const response = await axios.get("http://takeoutfood.k8s.com/identity-service/api/account/");
  ...
  const addAccount = async (id) => {
    try {
      const response = await axios.post(
        `http://takeoutfood.k8s.com/identity-service/api/account/add/${id}`,
        {
          username: username,
          firstname: firstname,
          lastname: lastname,
  ...
  const fetchRoleData = async () => {
    try {
      const response = await axios.get("http://takeoutfood.k8s.com/identity-service/api/role/");
  ...
  const updateAccount = async () => {
    try {
      await axios.put(
        `http://takeoutfood.k8s.com/identity-service/api/account/${selectedAccount.id}`,
        {
