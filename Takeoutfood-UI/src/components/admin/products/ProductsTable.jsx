...
const ProductsTable = () => {
  ...
  const fetchDiscountData = async () => {
    try {
      const response = await axios.get("http://takeoutfood.k8s.com/product-service/api/discount/");
  ...
  const DeleteProduct = async (id) => {
    try {
      await axios.delete(`http://takeoutfood.k8s.com/product-service/api/product/${id}`);
      fetchProductData();
  ...
  const addProduct = async (categoryId) => {
    try {
      const response = await axios.post(
        `http://takeoutfood.k8s.com/product-service/api/product/add/${categoryId}`,
        {
          name: productName,
          price: productPrice,
  ...
  const updateProduct = async () => {
    try {
      await axios.put(
        `http://takeoutfood.k8s.com/product-service/api/product/${selectedProduct.id}`,
        {
  ...
  const handleApplyDiscount = async (productId) => {
    ...
    try {
      await axios.put(
        `http://takeoutfood.k8s.com/product-service/api/product/applyDiscount/${productId}/${discountId}`
      );
  ...
  const handleCancelDiscount = async (productId) => {
    try {
      await axios.put(
        `http://takeoutfood.k8s.com/product-service/api/product/removeDiscount/${productId}`
      );
